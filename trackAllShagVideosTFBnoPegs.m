function [splinedSnakesX,splinedSnakesY] = trackAllShagVideosTFBnoPegs(directory)

if nargin<1
   directory =  'D:\SinglePeg\videos\untracked\';
end

splineDir = 'D:\SinglePeg\splines\';
...
for i = startIndex:length(files)
    ...
    [snakeX,snakeY,splineX,splineY,pegXY,pegR,keep] = trackSnakeInVideoOnShagNewTFBnoPegs(path); %#ok<*ASGLU>
